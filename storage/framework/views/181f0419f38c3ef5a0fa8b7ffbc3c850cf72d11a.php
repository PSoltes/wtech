...
<?php $__env->startSection('content'); ?>
    <nav class="checkout-nav">
            <span class="nav-row"><a class="checkout-nav-link" href="#">Obsah kosika</a><i
                        ...
                        class="fas fa-caret-right"></i><a
                        class="checkout-nav-link link-disabled" href="<?php echo e(url('checkout3')); ?>">Dodacie udaje</a></span>
    </nav>
    <?php if(!empty($CartItems)): ?>
        <section class="checkout-product-thmbs">
            ...
            <?php $__currentLoopData = $CartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <article class="checkout-product-thmb">
                    ...
                    <i class="fas fa-times deleteProduct" role="button" data-id="<?php echo e($cartItem->product->id); ?>"></i>
                    ...
                    <span class="product-amount"><i class="fa fa-minus remove-one"
                                                    data-id="<?php echo e($cartItem->product->id); ?>"></i><input class="amount-input"
                                                                                                    type="text"
                                                                                                    value="<?php echo e($cartItem->amount); ?>"
                                                                                                    data-id="<?php echo e($cartItem->product->id); ?>"
                                                                                                    id="<?php echo e('id'. $cartItem->product->id); ?>"><i
                                class="fa fa-plus add-one" data-id="<?php echo e($cartItem->product->id); ?>"></i></span>
        ...
        <section class="checkout-summary">
            ...
            <button class="white-bcg-button" id="nextButton" type="button"><a href="<?php echo e(url('checkout2')); ?>">Dalsi krok</a>
            </button>
        </section>
    <?php else: ?>
